...
class FaceIdentify(object):
    """
    Class for real time face identification
    """
    ...
    def identify_face(self, features, threshold=100):
        ...
        for person in self.precompute_features_map:
            ...
            distance = spatial.distance.euclidean(person_features,
                                                  features)  # Compare by Euclidean distance of feature map using scipy spatial
